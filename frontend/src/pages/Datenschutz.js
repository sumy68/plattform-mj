    ...
    <div style={{maxWidth:800,margin:'0 auto',padding:'40px 20px',fontFamily:'sans-serif'}}>
      ...
      <div style={{background:'white',borderRadius:16,padding:32,boxShadow:'0 4px 24px rgba(155,127,212,0.1)'}}>
        ...
        <Section title="11. Webhosting und Drittdienste">
          <strong>Render.com</strong> – Die Plattform wird über Render (Render Services, Inc., 525 Brannan Street, San Francisco, CA 94107, USA) gehostet. Render ist ein US-amerikanisches Unternehmen, betreibt jedoch ausschließlich EU-Rechenzentren für diese Plattform, sodass personenbezogene Daten die EU nicht verlassen. Technische Daten (IP-Adressen, Serverprotokolle) werden zur Bereitstellung des Dienstes verarbeitet (Art. 6 Abs. 1 lit. f DSGVO). Für den Fall eines Drittlandtransfers bestehen EU-Standardvertragsklauseln (SCC) gem. Art. 46 Abs. 2 lit. c DSGVO. Es besteht ein Auftragsverarbeitungsvertrag gem. Art. 28 DSGVO.<br/><br/>
